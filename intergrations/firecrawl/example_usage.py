...
async def example_single_url_scraping():
    ...
    # Configuration
    config = {"api_key": "fc-your-api-key-here", "api_url": "https://api.firecrawl.dev", "max_retries": 3, "timeout": 30, "rate_limit_delay": 1.0}  # Replace with your actual API key
...
async def example_configuration_validation():
    ...
    test_configs = [
        ...
        {"api_key": "invalid-key", "api_url": "https://api.firecrawl.dev"},  # Invalid format
        {"api_key": "fc-valid-key", "api_url": "invalid-url", "max_retries": 15, "timeout": 500, "rate_limit_delay": 15.0},  # Invalid URL  # Too high  # Too high  # Too high
    ]
