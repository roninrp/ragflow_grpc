    ...
    async def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            async with self.connector:
                ...
                return {"success": True, "message": "Successfully connected to Firecrawl API", "test_url": test_url, "response_time": "N/A"}  # Could be enhanced to measure actual response time
